...
Wenn Nearsec auf ein Problem stößt, wird ein standardisierter Fehlercode angezeigt.
...
- **E21**: Uinput-Berechtigung verweigert (Linux). Der Host muss Nearsec mit den entsprechenden `/dev/uinput`-Berechtigungen ausführen.

...
Se o Nearcade encontrar um problema, ele exibirá um código de erro padronizado.
...
- **E21**: permissão de entrada negada (Linux). O host deve executar o Nearcade com privilégios `/dev/uinput` apropriados.

...
# Add target alias
.PHONY: uinputBridge
uinputBridge: $(builddir)/uinputBridge.node

# Copy this to the executable output path.
$(builddir)/uinputBridge.node: TOOLSET := $(TOOLSET)
$(builddir)/uinputBridge.node: $(obj).target/uinputBridge.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/uinputBridge.node
# Short alias for building this executable.
.PHONY: uinputBridge.node
uinputBridge.node: $(obj).target/uinputBridge.node $(builddir)/uinputBridge.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/uinputBridge.node

...
This guide explains how to deploy the Nearcade central router on a Linux VPS. We use Caddy to handle SSL and WebSocket routing automatically.
...
```bash
cd /home/ubuntu
git clone [https://github.com/therealfame/nearcade.git](https://github.com/therealfame/nearcade.git)
cd nearcade
```
...
A: Caddy does not have the correct Linux file permissions to read your repository. Run `sudo chmod -R 755 /home/ubuntu/Nearcade/src` to unlock the folder.

...
If Nearcade encounters an issue, it will display a standardized error code.
...
- **E21**: uinput Permission Denied (Linux). The host must run Nearcade with appropriate `/dev/uinput` privileges.
